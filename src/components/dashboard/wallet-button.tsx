  ...
  if (!address) {
    return (
      <button
        ...
        className="inline-flex items-center gap-2 rounded-lg bg-slate-deep px-4 py-2 text-sm font-medium text-paper transition-colors duration-200 hover:bg-slate disabled:opacity-70"
      >
